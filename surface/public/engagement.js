...
// Display labels for source kinds intentionally kept out of the add-source dropdown
// (sourceKindMeta excludes them) but which can still appear in the Sources list — e.g.
// M365 sources dropped in by /vibe-collate running in the Copilot CLI.
const SRC_KIND_LABELS = { m365: 'M365 source', workshop: 'Workshop capture' };
function srcKindLabel(k) { return (SRC_KINDS[k] && SRC_KINDS[k].label) || SRC_KIND_LABELS[k] || k; }
