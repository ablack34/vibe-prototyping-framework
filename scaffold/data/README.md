...
2. **Demo fixture** — Run `/vibe-demo` to seed the Tailwind Traders fixture. The demo's four CSVs (returns, products, customers, reason-codes) get copied here as if they were customer data.
